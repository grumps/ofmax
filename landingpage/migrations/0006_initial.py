...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ContactLandingPage'
        db.create_table(u'landingpage_contactlandingpage', (
            (u'page_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['pages.Page'], unique=True, primary_key=True)),
            ('content', self.gf('mezzanine.core.fields.RichTextField')()),
            ('tracking_code', self.gf('django.db.models.fields.TextField')()),
            ('contact_form', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['forms.Form'])),
        ))
        db.send_create_signal(u'landingpage', ['ContactLandingPage'])


    def backwards(self, orm):
        # Deleting model 'ContactLandingPage'
        db.delete_table(u'landingpage_contactlandingpage')
